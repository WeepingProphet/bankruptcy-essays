...
EPISODES = [
    {
        "num": "04", "slug": "imprisonment-detention", "kicker": "הנחיה · מעצר",
        "title": "עשרה ימים, שני מסלולים, שומר סף אחד",
        "dek": "הנחיית הממונה החדשה משרטטת לנאמנים את גבולות הכלי הקיצוני ביותר בהליך: שלילת חירותו של חייב. השאלה המובילה — מתי מעצר הוא כלי לגיטימי בידי הנאמן, ומתי הוא מוקש?",
        "chips": ["הנחיה · מעצר", "עד 10 ימים", "≈ 8 דקות"],
        "lede": "מעצר אינו סנקציה עונשית אלא אמצעי אכיפה אחרון — מותנה, קצוב בזמן, ותמיד באישור בית המשפט.",
        "body": "הפרק מנתח את הנחיית הממונה בנוגע לבקשה למעצר חייב בהליך חדלות פירעון — הכלי החריף ביותר שעומד לרשות בעל התפקיד, ולכן גם הכבול ביותר. נבחין בין שני המסלולים שההנחיה מתווה, נעמוד על התנאים המקדימים שהנאמן חייב למצות לפני שהוא פונה לבקשה כזו, ועל תפקידו של בית המשפט כשומר הסף שבלעדיו אין מעצר. לנאמן זו מפת דרכים מעשית: מתי הבקשה בכלל לגיטימית, אילו אסמכתאות נדרשות, וכיצד לא להפוך אמצעי אכיפה לכלי לחץ פסול שיוחזר אליו כבומרנג.",
        "glyph": "10", "essay_title": "מתי מעצר הוא כלי לגיטימי — ומתי מוקש",
    },
    {
        "num": "03", "slug": "48790-07-16", "kicker": "פסיקה · חילוט",
        "title": "10.1 מיליון ₪, שתי קופות, חילוט אחד",
        "dek": "בהסדר הטיעון בפרשת בריל הוכרע גורלם של כספים שכבר ישבו בקופת הכנ״ר ובקופת המפרקים הזמניים — לא בהליך החדלות, אלא בחילוט פלילי. השאלה לנאמן: כשנכסי החייב מוחזקים אצלך, מי באמת מכריע את ייעודם?",
        "chips": ["פסיקה · חילוט", "ת״פ 48790-07-16", "≈ 10 דקות"],
        "lede": "כשהליך פלילי רץ במקביל לחדלות פירעון, החילוט יכול לשלוף כספים היישר מקופת הנשייה — לפני הנושים.",
        "body": "הפרק עוקב אחר גזר הדין בהסדר הטיעון בפרשת בריל: הרשעה בשורה ארוכה של עבירות מרמה, הלבנת הון ועבירות מס, שלצידה חילוט של כ־10.1 מיליון ₪ ו־52 חודשי מאסר. הצומת המעניין לנאמן הוא רגע החפיפה בין ההליך הפלילי לקופת הנשייה: בית המשפט הורה על חילוט כספים שכבר ישבו בקופת הכנ״ר ובקופת המפרקים הזמניים, בהתאם למנגנון שנקבע בע״פ 9627/16. נדבר על מה קורה כשנכסי החייב מוחזקים אצל בעל התפקיד בזמן שההליך הפלילי מכריע את ייעודם, איך למפות מראש את רכיבי החילוט מול נכסי הקופה, ומדוע תיאום עמדות מול הפרקליטות והממונה הוא ההגנה המעשית על אינטרס הנושים.",
        "glyph": "§", "essay_title": "היכן פוגש ההליך הפלילי את קופת הנשייה",
    },
    {
